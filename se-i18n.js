...
const STRINGS = {
  ja: {
    ...
    'preset.saveAsJson': '💾 名前を付けて保存 (.json)',
    'preset.saveJsonOverwrite': '上書き保存 (.json)',
    ...
    'library.reorderBtn': '並べ替え',
    'library.reorderDone': '完了',
    'library.reorderHandleTitle': 'ドラッグして並べ替え',
    ...
    'toast.importLinkHint': '（同じファイルへ上書きするには「名前を付けて保存」で保存先を指定してください）',
    'toast.importFailed': 'JSONの読み込みに失敗しました',
    'toast.jsonLinkedSave': 'ファイルに保存し、上書き用に紐づけました',
    'toast.jsonSavedOverwrite': 'ファイルに上書き保存しました',
    'toast.jsonNoLinkedFile': '先に「名前を付けて保存」でファイルを指定してください',
    'toast.jsonOverwriteNoFs': 'このブラウザでは上書き保存できません（エクスポートでダウンロードできます）',
    'toast.jsonWriteDenied': 'ファイルへ書き込めませんでした（権限またはファイルの有無を確認してください）',
    'toast.jsonSaveFailed': '保存に失敗しました',
  ...
  en: {
    ...
    'preset.saveAsJson': '💾 Save As (.json)',
    'preset.saveJsonOverwrite': 'Overwrite (.json)',
    ...
    'library.reorderBtn': 'Reorder',
    'library.reorderDone': 'Done',
    'library.reorderHandleTitle': 'Drag to reorder',
    ...
    'toast.importLinkHint': '(Use Save As to link a file for overwrite later.)',
    'toast.importFailed': 'Failed to load JSON',
    'toast.jsonLinkedSave': 'Saved and linked for overwrite',
    'toast.jsonSavedOverwrite': 'File overwritten',
    'toast.jsonNoLinkedFile': 'Use Save As first to choose a file',
    'toast.jsonOverwriteNoFs': 'Overwrite is not available in this browser (use Export to download)',
    'toast.jsonWriteDenied': 'Could not write to file (check permission or if the file exists)',
    'toast.jsonSaveFailed': 'Save failed',
